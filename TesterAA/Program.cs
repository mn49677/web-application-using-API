...
namespace TesterAA
{
    class Program
    {
        ...
        static async void MainAsync(string[] args)
        {
            ...
            long[,] matrixHYB = await solvers.CalculateTimeMatrix(Solvers.MODE_HYBRID, 3, 100000);
            long[,] matrixHAV = await solvers.CalculateTimeMatrix(Solvers.MODE_MANHATTAN, 3, 100000);
            long[,] matrixORS = await solvers.CalculateTimeMatrix(Solvers.MODE_ORS, 3, 100000);
